...
s3 = Section.create(name: '6AScience', teacher_id: t2.id)
s4 = Section.create(name: '6BScience', teacher_id: t2.id)
...
st10 = Student.create(firstname: 'Kite' , lastname: 'Brave', section_id: s4.id)
